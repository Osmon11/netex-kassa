...
import { Success } from "../Dashboard/CreateProject";
...
export function NewRequest() {
  ...
  return Boolean(merchantsFiltered) ? (
    <div className='flex_box'>
      <section style={{ width: "100%" }}>
        <div className='title' style={{ fontSize: 25, textAlign: "center" }}>
          Вывод средств
        </div>
        <Stepper
        ...
        >
          {steps.map((label, index) => {
            return (
              <Step key={label} style={{ padding: "0px 20px" }}>
                <CustomLabel
                    ...
                    (obj) =>
                      merchantDetail.requisite[obj.key] && (
                        <>
                          ...
                          <ThemeInput
                            value={merchantDetail.requisite[obj.key]}
                            name={obj.key}
                            type='text'
                            variant='outlined'
                            disabled
